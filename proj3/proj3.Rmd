...
pacman::p_load(tidyverse, nlme, arsenal, mice, lattice, DataExplorer, reshape2,broom.mixed, ggResidpanel,gplots)
```
...
mod11_df <- summary(mice::pool(mod11)) 
...
mod22_df <- summary(mice::pool(mod22)) 
...
mod110_df <- summary(mice::pool(mod110)) 
...
mod120_df <- summary(mice::pool(mod120)) 
...
mod150_df <- summary(mice::pool(mod150)) 
...
mod210_df <- summary(mice::pool(mod210)) 
...
mod220_df <- summary(mice::pool(mod220)) 
...
mod250_df <- summary(mice::pool(mod250)) 
