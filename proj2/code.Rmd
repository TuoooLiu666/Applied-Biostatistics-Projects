...
design_s <- svydesign(id=data$SDMVPSU, strata=data$SDMVSTRA, weights = data$WTINT2YR, data=data, nest=T)

# age among vaping & non-vaping
svyby(~RIDAGEYR, ~SMQ900, design_s, svymean, na.rm = T)

# Num. of cigarette/day among vaping & non-vaping
svyby(~SMQ720, ~SMQ900, design_s, svymean, na.rm = T)
