...
pacman::p_load(survey, tidyverse, DataExplorer, arsenal, survey)
```
...
```{r results="asis"}
data <- data %>% select(1:4, 8:11, 16:17, 20, 24:26, 33) %>% filter(SMQ900 != 9)
...
table <- arsenal::tableby(SMQ900 ~  RIAGENDR + RIDAGEYR + RIDRETH3 + SMQ040 + SMQ720 + LBXBPB + BMXBMI + ALQ111, data = dat, control = my_controls)
